...
print(f1, fullfile(folder_out, 'Fig1_FT_Performance.png'), '-dpng', '-r300');
...
% FORCE STYLE
force_black_style(gca, t_obj, s_obj, lgd);
print(f2, fullfile(folder_out, 'Fig2_ANFIS_Performance.png'), '-dpng', '-r300');
...
% FORCE STYLE
force_black_style(gca, t_obj, s_obj, lgd);
print(f3, fullfile(folder_out, 'Fig3_Best_Step.png'), '-dpng', '-r300');
...
% FORCE STYLE
force_black_style(gca, t_obj, s_obj, lgd);
print(f4, fullfile(folder_out, 'Fig4_Worst_Step.png'), '-dpng', '-r300');

fprintf('Figures saved in PNG format (300 DPI) with Black Text/White Background.\n');
